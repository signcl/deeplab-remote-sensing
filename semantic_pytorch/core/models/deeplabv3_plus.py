...
class DeepLabV3Plus(nn.Module):
    ...
    def __init__(self, channels=2, backbone='xception', aux=True, pretrained_base=False, dilated=True, **kwargs):
        ...
        self.head = _DeepLabHead(nclass=8, **kwargs)
        if aux:
            
            self.auxlayer = _FCNHead(728, channels, **kwargs)
